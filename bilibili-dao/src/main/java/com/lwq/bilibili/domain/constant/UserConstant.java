...
public interface UserConstant {
    ...
    public static final String BIRTH_DEAULT = "1999-01-01";
    public static final String NICK_DEFUALT = "萌新";
    ...
    public static final String USER_FOLLOWING_GROUUP_ALL_NAME = "全部分组";
}
